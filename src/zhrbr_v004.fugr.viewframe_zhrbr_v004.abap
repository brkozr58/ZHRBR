*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHRBR_V004
*   generation date: 27.01.2022 at 17:16:32
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHRBR_V004          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHRBR_V004'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHRBR_V004_EXTRACT
TOTAL = ZHRBR_V004_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHRBR_V004'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHRBR_V004-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHRBR_V004_EXTRACT
TOTAL = ZHRBR_V004_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHRBR_V004-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHRBR_V004'
...
TOTAL = ZHRBR_V004_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHRBR_V004-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHRBR_V004-UPD_FLAG NE SPACE.
