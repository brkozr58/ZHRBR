*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZHRBR_V006
*   generation date: 13.01.2020 at 21:04:11
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZHRBR_V006          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZHRBR_V006'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZHRBR_V006_EXTRACT
TOTAL = ZHRBR_V006_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZHRBR_V006'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZHRBR_V006-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZHRBR_V006_EXTRACT
TOTAL = ZHRBR_V006_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZHRBR_V006-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZHRBR_V006'
...
TOTAL = ZHRBR_V006_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZHRBR_V006-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZHRBR_V006-UPD_FLAG NE SPACE.
